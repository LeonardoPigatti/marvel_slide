...
<article class="slider slider--active-1">
  <section style="background-color: #475A51;" class="slider__slide slide slide--1">
    <h2 class="h2 h2--top">I am</h2>
    <img class="slide__img" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/108082/groot.png" alt="Groot">
    <h2 class="h2 h2--bottom">Groot</h2>
  </section>
  <section style="background-color: #E89756;" class="slider__slide slide slide--2">
    <h2 class="h2 h2--top">Rocket</h2>
    <img class="slide__img" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/108082/raccoon.png" alt="Raccoon">
    <h2 class="h2 h2--bottom">Raccoon</h2>
  </section>
  <nav class="slider__navigation navigation">
    <a href="javascript:void(0);" class="navigation__item nav nav--1">
    ...
    <a style="background-color: #E89756;" href="javascript:void(0);" class="navigation__item nav nav--2">
      <div class="nav__border">
...
export default {
  ...
  mounted() {
    $(function() {
      var slider = $('.slider');
      var slide = $('.slide');
      var nav = $('.nav'); // Remover variável não utilizada se não precisar
